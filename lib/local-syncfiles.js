...
const syncFiles = function (srcDir, targetDir, { type, exclude, forceSync, afterSync, deleteOrphaned, filter, onError }) {
    try {
...
module.exports = (srcDir, targetDir, { type, exclude, forceSync, afterSync, deleteOrphaned, filter, onError }) => {
    fse.ensureDirSync(targetDir);
    syncFiles(srcDir, targetDir, { type, exclude, forceSync, afterSync, deleteOrphaned, filter, onError });
};
