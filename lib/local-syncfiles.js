...
const syncFiles = function(srcDir, targetDir, { type, exclude, afterSync, deleteOrphaned }) {
...
module.exports = (srcDir, targetDir, { type, exclude, afterSync }) => {
    fse.ensureDirSync(targetDir);
    syncFiles(srcDir, targetDir, { type, exclude, afterSync });
};
