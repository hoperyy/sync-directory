...
const syncFiles = function(srcDir, targetDir, { type, exclude, afterSync, deleteOrphaned, filter }) {
...
module.exports = (srcDir, targetDir, { type, exclude, afterSync, filter }) => {
    fse.ensureDirSync(targetDir);
    syncFiles(srcDir, targetDir, { type, exclude, afterSync, filter });
};
